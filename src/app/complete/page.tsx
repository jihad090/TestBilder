...
export default function CompleteTemplateTable() {
    ...
    try {
      ...
      if (data.success) {
        const completed = data.data.filter((t: TemplateItem) =>
          t.examType === "sq" ? t.sqGroup?.isComplete === true : t.isComplete === true,
        )
  ...
  return (
    <div className="p-4">
      <p className="text-3xl text-center bg-white mb-4">Complete Questions</p>
      ...
      {userId === null ? ( 
        ...
        <>
          ...
          <ScrollArea className="h-[75vh]">
            <Table>
              <TableCaption>A list of your complete question templates.</TableCaption>
              ...
              <TableBody>
                {loading ? (
                  ...
                  filteredTemplates.map((item, idx) => (
                    <TableRow key={item._id} className="bg-green-200 border-4">
